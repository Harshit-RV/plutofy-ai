  ...
  return (
    !agentLoading || agent != undefined ? (
      <div className='flex flex-col font-mono min-h-screen bg-gray-100'>
          ...
          <div className="flex flex-col gap-5 flex-grow px-3 sm:px-10 md:px-14 xl:px-48 pt-4 w-full">
            <Collapsible
              open={isConfigOpen}
            ...
            <Tabs defaultValue={isTestMode ? "test" : "usage"}>
              ...
              <TabsContent value="usage" className="pt-3">
                <div className="bg-white w-full flex justify-center py-10 items-center rounded-lg border">
                  Coming Soon..
                </div>
              </TabsContent>

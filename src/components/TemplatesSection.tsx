...
const TemplatesSection = ({ collapsible = true, refetch } : { collapsible?: boolean, refetch: () => void }) => {
  ...
  const templateAgents : Omit<AgentProps, "userId">[] = [
    {
      ...
      outputStructure: [
        { name:"idea", type:"object", fields:[
          { id:"1738662132509", name: "name", type:"string"},
          { id:"1738662137249", name: "estimated_time_to_build_in_days", type:"number"},
          { id:"1738662143387", name: "tech_stack", type:"string"},
          { id:"1738662151411", name: "description", type:"string"},
          { id:"1738662155943", name: "isBlockchainRelated", type:"boolean"}
        ...
        { id:"1738662171098", name:"target_audience", type:"string", fields:[] }
      ],
    },
  ];
      ...
      <Collapsible className="w-full space-y-5 ">
          <CollapsibleTrigger asChild>
              <div className="flex items-center space-x-4 py-1 rounded-xl shadow-sm border-2 border-gray-200 hover:border-gray-300 hover:cursor-pointer px-4">
                  <h1 className='font-black text-md font-poppins text-gray-600'>Templates</h1>
  ...
  return (
      <div className="w-full space-y-4">
          <div className="flex items-center">
              <h1 className='font-black text-lg font-poppins'>Templates</h1>
          </div>
          <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3">
            {
              templateAgents.map((agent) => (

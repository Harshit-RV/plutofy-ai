    ...
    return (
      <Collapsible className="w-full space-y-5 ">
        <CollapsibleTrigger asChild>
          <div className="flex items-center space-x-4 py-1 rounded-xl shadow-sm border-2 border-gray-200 dark:border-gray-900 hover:border-gray-300 dark:hover:border-gray-800 hover:cursor-pointer px-4">
